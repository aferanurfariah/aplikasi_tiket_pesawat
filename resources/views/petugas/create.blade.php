    ...
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">From Petugas</h3>
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="penumpang_id">Id Penumpang</label>
                        <input type="text" class="form-control" name="penumpang_id" id="penumpang_id" placeholder="Masukan id">
                      </div>
                  <!-- /.form-group -->
                  <div class="form-group">
